...
<Steps>
  <Step title="Sign Up and Get Your API Key">
    ...
    2. After signing up, visit your dashboard 3. Copy your API key from the
    dashboard
    <Note>
...
<Tip>
  Adjust this prompt to fit your specific use case, such as customer support,
  language learning, or technical help.
</Tip>
...
<Card
  ...
  horizontal
>
  List of all available voice IDs with their description and tested out use
  cases.
</Card>
...
<Check>
  Congratulations! You now have a real-time AI voice assistant running on your
  machine.
</Check>
